...
In an analogous way to what has been done in\secref{Sec1:QED}, this invariance can be made local by implementing a proper covariant derivative, similar to \eqref{1:QEDCovDeriv}.
