\pagestyle{myFancy}
\chapter{Quantum Chromodynamics on the Lattice}
...
This first section is mostly taken from Srednicki \cite{srednicki2007quantum}, personal notes and computations.
...
The second one is that, if nonabelian gauge groups are taken into consideration, this action naturally introduces self-interacting cubic and quartic terms, because the structure constants $f^{abc}$ are non $0$. This is, for example, the case for the group $\SU(2)$, that is used to describe isospin, and for the group $\SU(3)$, that is used to describe gluon interaction, \ie Quantum Chromodynamics (QCD).
