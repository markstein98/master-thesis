...
This first section is based on material that can be found in standard textbooks on quantum field theory \cite{srednicki2007quantum} \cite{peskin1995introduction} \cite{weinberg1995quantum} \cite{kaku1993quantum} \cite{ramond1997field}, personal notes and computations.
